       ...
       AUTHOR. 日本版CardDemo.
      ******************************************************************
      * 取引タイプ更新 オンラインプログラム(日本版・CICS)
      * 取引タイプの漢字説明を更新する
      * BMS マップ COTRTJU を介し、漢字フィールドを DBCS 属性で表示/入力。
      *
      * 日本語オンライン処理の要点:
      ...
      ******************************************************************
       ...
       01  WS-PROGRAM-ID            PIC X(8) VALUE 'COTRTJUP'.
       01  WS-TRANID                PIC X(4) VALUE 'CU00'.
       01  WS-MAPNAME               PIC X(7) VALUE 'COTRTJU'.
