       ...
       AUTHOR. 日本版CardDemo.
      ******************************************************************
      * 与信照会 オンラインプログラム(日本版・CICS)
      * 与信明細の漢字加盟店名を照会する
      * BMS マップ COPAUJS を介し、漢字フィールドを DBCS 属性で表示/入力。
      *
      * 日本語オンライン処理の要点:
      ...
      ******************************************************************
       ...
       01  WS-PROGRAM-ID            PIC X(8) VALUE 'COPAUJS0'.
       01  WS-TRANID                PIC X(4) VALUE 'CP00'.
       01  WS-MAPNAME               PIC X(7) VALUE 'COPAUJS'.
