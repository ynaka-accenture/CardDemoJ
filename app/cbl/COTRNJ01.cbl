       ...
       AUTHOR. 日本版CardDemo.
      ******************************************************************
      * 取引照会 オンラインプログラム(日本版・CICS)
      * 取引の漢字摘要を照会する
      * BMS マップ COTRN01 を介し、漢字フィールドを DBCS 属性で表示/入力。
      *
      * 日本語オンライン処理の要点:
      ...
      ******************************************************************
       ...
       01  WS-PROGRAM-ID            PIC X(8) VALUE 'COTRNJ01'.
       01  WS-TRANID                PIC X(4) VALUE 'CT01'.
       01  WS-MAPNAME               PIC X(7) VALUE 'COTRN01'.
