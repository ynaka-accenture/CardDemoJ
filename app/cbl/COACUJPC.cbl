       ...
       AUTHOR. 日本版CardDemo.
      ******************************************************************
      * 口座更新 オンラインプログラム(日本版・CICS)
      * 顧客の漢字氏名・住所を入力・更新する
      * BMS マップ COACUJP を介し、漢字フィールドを DBCS 属性で表示/入力。
      *
      * 日本語オンライン処理の要点:
      ...
      ******************************************************************
       ...
       01  WS-PROGRAM-ID            PIC X(8) VALUE 'COACUJPC'.
       01  WS-TRANID                PIC X(4) VALUE 'CAUJ'.
       01  WS-MAPNAME               PIC X(7) VALUE 'COACUJP'.
