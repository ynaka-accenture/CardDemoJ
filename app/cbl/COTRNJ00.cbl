       ...
       AUTHOR. 日本版CardDemo.
      ******************************************************************
      * 取引追加 オンラインプログラム(日本版・CICS)
      * 漢字摘要・円記号金額・漢字加盟店名を入力する
      * BMS マップ COTRNJ0 を介し、漢字フィールドを DBCS 属性で表示/入力。
      *
      * 日本語オンライン処理の要点:
      ...
      ******************************************************************
       ...
       01  WS-PROGRAM-ID            PIC X(8) VALUE 'COTRNJ00'.
       01  WS-TRANID                PIC X(4) VALUE 'CT00'.
       01  WS-MAPNAME               PIC X(7) VALUE 'COTRNJ0'.
      ...
      *    漢字フィールドの SO/SI 解析(有効文字数・外字・不整合)
           MOVE TRAN-KANJI-DESC TO JCK-FIELD
