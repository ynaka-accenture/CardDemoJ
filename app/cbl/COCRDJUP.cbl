       ...
       AUTHOR. 日本版CardDemo.
      ******************************************************************
      * カード更新 オンラインプログラム(日本版・CICS)
      * 漢字エンボス名を入力・更新する
      * BMS マップ COCRDJU を介し、漢字フィールドを DBCS 属性で表示/入力。
      *
      * 日本語オンライン処理の要点:
      ...
      ******************************************************************
       ...
       01  WS-PROGRAM-ID            PIC X(8) VALUE 'COCRDJUP'.
       01  WS-TRANID                PIC X(4) VALUE 'CCUP'.
       01  WS-MAPNAME               PIC X(7) VALUE 'COCRDJU'.
      ...
      *    漢字フィールドの SO/SI 解析(有効文字数・外字・不整合)
           MOVE CARD-KANJI-EMBOSSED-NAME TO JCK-FIELD
