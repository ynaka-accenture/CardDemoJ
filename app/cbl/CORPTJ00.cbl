       ...
       AUTHOR. 日本版CardDemo.
      ******************************************************************
      * 帳票出力 オンラインプログラム(日本版・CICS)
      * 漢字を含む帳票の出力を行う
      * BMS マップ CORPTJ0 を介し、漢字フィールドを DBCS 属性で表示/入力。
      *
      * 日本語オンライン処理の要点:
      ...
      ******************************************************************
       ...
       01  WS-PROGRAM-ID            PIC X(8) VALUE 'CORPTJ00'.
       01  WS-TRANID                PIC X(4) VALUE 'CR00'.
       01  WS-MAPNAME               PIC X(7) VALUE 'CORPTJ0'.
