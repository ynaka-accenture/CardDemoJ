       ...
       AUTHOR. 日本版CardDemo.
      ******************************************************************
      * 取引一覧 オンラインプログラム(日本版・CICS)
      * 取引の漢字加盟店名を一覧表示する
      * BMS マップ COTRN02 を介し、漢字フィールドを DBCS 属性で表示/入力。
      *
      * 日本語オンライン処理の要点:
      ...
      ******************************************************************
       ...
       01  WS-PROGRAM-ID            PIC X(8) VALUE 'COTRNJ02'.
       01  WS-TRANID                PIC X(4) VALUE 'CT02'.
       01  WS-MAPNAME               PIC X(7) VALUE 'COTRN02'.
      ...
      *    漢字フィールドの SO/SI 解析(有効文字数・外字・不整合)
           MOVE TRAN-KANJI-MERCHANT-NAME TO JCK-FIELD
